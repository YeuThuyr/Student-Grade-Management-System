            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand d-flex align-items-center gap-3" href="<?php echo BASE_PATH; ?>index.php">
                    ...
                    <div class="d-flex flex-column lh-sm">
                        <span class="fw-bold fs-6 text-white text-uppercase tracking-wide">Đại Học Bách Khoa Hà
                            Nội</span>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                    <ul class="navbar-nav align-items-center gap-2 gap-lg-4 mx-auto mb-3 mb-lg-0 mt-3 mt-lg-0">
                        ...
                        <?php if ($isLoggedIn): ?>
                            ...
                            <?php if ($role === 'admin'): ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>students/list.php">Sinh
                                        viên</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>subjects/list.php">Môn
                                        học</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>grades/list.php">Điểm</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>classes/list.php">Lớp</a>
                                </li>
                            <?php elseif ($role === 'student'): ?>
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>students/profile.php">Hồ
                                        sơ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link nav-link-custom" href="<?php echo BASE_PATH; ?>grades/list.php">Bảng
                                        điểm</a>
                                </li>
                            <?php endif; ?>
                        <?php endif; ?>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <?php if ($isLoggedIn): ?>
                            <a href="<?php echo BASE_PATH; ?>auth/logout.php" class="btn login-btn px-4 text-nowrap">ĐĂNG
                                XUẤT</a>
                        <?php else: ?>
                            <a href="<?php echo BASE_PATH; ?>auth/login.php" class="btn login-btn px-4 text-nowrap">ĐĂNG
                                NHẬP</a>
                        <?php endif; ?>
                    </div>
                </div>
