...
ALTER TABLE feedback_messages AUTO_INCREMENT = 1;
...
('KHMT-01', 'Khoa học máy tính 1', 'Khoa học máy tính', 'TS. Lê Anh Dũng', 'Active', 'Lớp chuyên ngành Khoa học máy tính'),
('DTVT-01', 'Điện tử viễn thông 1', 'Điện tử viễn thông', 'PGS. Ngô Quang Huy', 'Active', 'Lớp chuyên ngành Điện tử viễn thông'),
('QTKD-01', 'Quản trị kinh doanh 1', 'Quản trị kinh doanh', 'ThS. Vũ Thị Mai', 'Active', 'Lớp chuyên ngành Quản trị kinh doanh'),
('CDT-01', 'Cơ điện tử 1', 'Cơ điện tử', 'TS. Bùi Minh Khánh', 'Active', 'Lớp chuyên ngành Cơ điện tử'),
('ATTT-01', 'An toàn thông tin 1', 'An toàn thông tin', 'TS. Trịnh Quốc Bảo', 'Active', 'Lớp chuyên ngành An toàn thông tin');
...
('20240001', 'Bùi Minh Khánh', '2006-02-14', 'Male', 'khanh.bm@gmail.com', '0956567890', 'Lào Cai', 4, 1),
('20240456', 'Ngô Kiến Huy', '2006-07-08', 'Male', 'huy.nk@gmail.com', '0967678901', 'Gia Lai', 5, 1),
...
('20220500', 'Lý Minh Hải', '2004-06-06', 'Male', 'hai.lm@gmail.com', '0990901234', 'Tiền Giang', 6, 1),
...
('MATH102', 'Giải tích II', 3, 'Tích phân bội, chuỗi số và phương trình vi phân'),
('PHYS102', 'Vật lý đại cương II', 4, 'Điện từ học, quang học và vật lý hiện đại'),
('CS302', 'Mạng máy tính', 3, 'Kiến trúc mạng, TCP/IP và bảo mật mạng'),
('CS401', 'Trí tuệ nhân tạo', 4, 'Tìm kiếm, học máy cơ bản và mạng nơ-ron'),
('STAT201', 'Xác suất thống kê', 3, 'Biến ngẫu nhiên, phân phối và kiểm định giả thuyết'),
('ECON101', 'Kinh tế vi mô', 3, 'Cung cầu, thị trường và hành vi người tiêu dùng'),
('EE101', 'Mạch điện cơ bản', 3, 'Định luật mạch điện và phân tích tín hiệu'),
('ME101', 'Cơ học kỹ thuật', 3, 'Tĩnh học, động học và ứng dụng cơ khí');
...
(1, 9, 8.0, 8.5, 8.0, 8.3, 'A', '2', '2023-2024'),
-- Sinh viên 2 (Bình)
(2, 1, 9.0, 8.5, 9.0, 8.8, 'A', '1', '2023-2024'),
(2, 3, 10.0, 9.5, 10.0, 9.8, 'A+', '1', '2023-2024'),
(2, 5, 8.0, 8.5, 8.5, 8.3, 'A', '2', '2023-2024'),
(2, 10, 7.5, 8.0, 8.0, 7.8, 'B+', '2', '2023-2024'),
-- Sinh viên 3 (Cường)
(3, 2, 6.0, 7.0, 7.5, 6.8, 'B', '1', '2023-2024'),
(3, 5, 8.5, 9.0, 8.0, 8.6, 'A', '1', '2023-2024'),
(3, 6, 7.5, 8.0, 8.5, 7.9, 'B+', '2', '2023-2024'),
(3, 11, 6.5, 7.0, 7.5, 6.9, 'B', '2', '2023-2024'),
-- Sinh viên 4 (Đức)
(4, 3, 4.0, 4.5, 5.0, 4.5, 'D', '1', '2023-2024'),
(4, 1, 3.0, 2.0, 4.0, 2.7, 'F', '1', '2023-2024'),
(4, 7, 5.5, 6.0, 6.0, 5.8, 'C', '2', '2023-2024'),
(4, 12, 6.0, 6.5, 6.0, 6.3, 'C+', '2', '2023-2024'),
-- Sinh viên 5 (Hà)
(5, 7, 9.5, 10.0, 10.0, 9.9, 'A+', '1', '2023-2024'),
(5, 8, 8.0, 8.5, 9.0, 8.5, 'A', '1', '2023-2024'),
(5, 13, 8.5, 9.0, 9.0, 8.8, 'A', '2', '2023-2024'),
(5, 14, 7.5, 8.0, 8.5, 8.0, 'B+', '2', '2023-2024'),
-- Sinh viên 6 (Hùng)
(6, 1, 6.5, 6.0, 7.0, 6.4, 'C+', '1', '2022-2023'),
(6, 4, 7.5, 8.0, 7.0, 7.6, 'B', '1', '2022-2023'),
(6, 8, 6.0, 6.5, 7.0, 6.5, 'C+', '2', '2022-2023'),
(6, 15, 7.0, 7.5, 7.5, 7.4, 'B', '2', '2022-2023'),
-- Sinh viên 7 (Thảo)
(7, 2, 9.0, 9.5, 9.0, 9.3, 'A', '1', '2022-2023'),
(7, 3, 8.5, 8.0, 9.0, 8.4, 'B+', '1', '2022-2023'),
(7, 9, 8.0, 8.5, 8.5, 8.3, 'A', '2', '2022-2023'),
(7, 16, 7.5, 8.0, 8.0, 7.8, 'B+', '2', '2022-2023'),
-- Sinh viên 8 (Khánh)
(8, 1, 4.0, 3.0, 5.0, 3.8, 'F', '1', '2024-2025'),
(8, 4, 5.0, 5.5, 6.0, 5.5, 'C', '1', '2024-2025'),
(8, 10, 6.0, 6.5, 7.0, 6.5, 'C+', '2', '2024-2025'),
(8, 12, 7.0, 7.5, 7.5, 7.4, 'B', '2', '2024-2025'),
-- Sinh viên 9 (Huy)
(9, 2, 7.0, 7.5, 8.0, 7.5, 'B', '1', '2024-2025'),
(9, 5, 8.0, 8.5, 8.0, 8.3, 'A', '1', '2024-2025'),
(9, 11, 7.5, 8.0, 8.5, 7.9, 'B+', '2', '2024-2025'),
(9, 15, 6.5, 7.0, 7.0, 6.9, 'B', '2', '2024-2025'),
-- Sinh viên 10 (Lan Anh)
(10, 5, 10.0, 10.0, 10.0, 10.0, 'A+', '1', '2021-2022'),
(10, 6, 9.0, 8.5, 9.5, 8.9, 'A', '1', '2021-2022'),
(10, 13, 9.0, 9.5, 9.0, 9.3, 'A+', '2', '2021-2022'),
(10, 14, 8.5, 9.0, 9.0, 8.8, 'A', '2', '2021-2022'),
-- Sinh viên 11 (Long)
(11, 1, 7.5, 8.0, 8.0, 7.8, 'B+', '1', '2023-2024'),
(11, 4, 8.0, 8.5, 8.5, 8.3, 'A', '1', '2023-2024'),
(11, 6, 7.0, 7.5, 7.5, 7.4, 'B', '2', '2023-2024'),
(11, 11, 8.5, 8.0, 8.5, 8.2, 'B+', '2', '2023-2024'),
-- Sinh viên 12 (Hải)
(12, 8, 6.5, 7.0, 7.5, 6.9, 'B', '1', '2022-2023'),
(12, 10, 7.0, 7.5, 8.0, 7.5, 'B', '1', '2022-2023'),
(12, 12, 6.0, 6.5, 7.0, 6.5, 'C+', '2', '2022-2023'),
(12, 16, 7.5, 8.0, 8.0, 7.8, 'B+', '2', '2022-2023'),
-- Sinh viên 13 (Thành)
(13, 1, 10.0, 10.0, 10.0, 10.0, 'A+', '1', '2023-2024'),
(13, 8, 10.0, 9.5, 10.0, 9.8, 'A+', '1', '2023-2024'),
(13, 9, 9.5, 9.0, 9.5, 9.3, 'A+', '2', '2023-2024'),
(13, 15, 8.5, 9.0, 9.0, 8.8, 'A', '2', '2023-2024'),
-- Sinh viên 14 (Hương)
(14, 3, 8.0, 8.5, 9.0, 8.5, 'A', '1', '2023-2024'),
(14, 7, 7.5, 8.0, 8.0, 7.8, 'B+', '1', '2023-2024'),
(14, 13, 8.5, 9.0, 9.0, 8.8, 'A', '2', '2023-2024'),
(14, 14, 7.0, 7.5, 8.0, 7.5, 'B', '2', '2023-2024'),
-- Sinh viên 15 (Bảo)
(15, 3, 8.0, 8.5, 9.0, 8.5, 'A', '1', '2023-2024'),
(15, 5, 7.5, 8.0, 8.0, 7.8, 'B+', '1', '2023-2024'),
(15, 6, 8.0, 8.5, 8.5, 8.3, 'A', '2', '2023-2024'),
(15, 11, 7.0, 7.5, 8.0, 7.5, 'B', '2', '2023-2024');
